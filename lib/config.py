...
# BASE PATH
CONF.ROOT = "/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/Pointnet2.ScanNet" # TODO change this
CONF.SCANNET_DIR =  "/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/Pointnet2.ScanNet/data/raw_data" # TODO change this
...
CONF.ENET_FEATURES_PATH = os.path.join(CONF.ENET_FEATURES_SUBROOT, "{}.npy_full_points.npy") # frame_id
...
CONF.SCANNETV2_QUERY = os.path.join(CONF.ROOT, "data/scannetv2_query.txt")
CONF.SCANNETV2_LIST = os.path.join(CONF.ROOT, "data/scannetv2.txt")
CONF.SCANNETV2_FILE = os.path.join(CONF.PREP_SCANS, "{}.npy_full_points.npy") # scene_id
CONF.SCANNETV2_QUERY_FILE = os.path.join(CONF.PREP_SCANS, "{}.npy_full_points.npy") # scene_id
