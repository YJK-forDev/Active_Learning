...
class Solver():
    ...
    def _get_scene_list(self, train_path, query_path):
        ...
        with open(train_path) as f:
            ...
            train_scene_list = scene_list # train_list에 있는 모든 scene을 사용함
        scene_list = []
        with open(query_path) as f:
            for scene_id in f.readlines():
                scene_list.append(scene_id.strip())
            query_scene_list = scene_list # query_list 있는 모든 scene을 사용함
    ...
    def __call__(self, args, epoch, verbose, occlusion_round):
        ...
        #pretrained_root = "/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/Pointnet2.ScanNet/outputs/2021-07-29_11-24-45_MSG"
        ...
        # 초기 train data로 5번 학습 수행함 1/12
        for epoch_id in range(self.epoch):
            print("epoch {} starting...".format(epoch_id + 1))
            
            # generate new chunks
            # 매 epoch마다 train 직전에 8192(dataset.npoints개)의 점을 랜덤하게 뽑아냄
        ...
        #while(final!="0"):
        #  final = input()
        user_file_name = "/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/Pointnet2.ScanNet/user_input/"+args.scene_number+"__"+args.annotation_label+"__"+args.method+"__"+args.tag+".txt"
        ...
        while line:
          ...
          for i in new_input:
            ...
            #print("일단 또 찍어봐 : ", query_scene_data[:3,1])
    ...
    def _train(self, train_loader, epoch_id, active = False):
        ...
        for iter_id, data in enumerate(train_loader):
            ...
            if (iter_id ==0) and (active==False) :
              ...
              np.savetxt('/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/data_test_second.txt', data[0][1].numpy())
            """
            ...
            if (iter_id ==1) and (active==False) :
              ...
              np.savetxt('/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/data_test.txt', preds.cpu().detach().numpy()[0])
    ...
    def _val_confidence_points (self, val_loader, epoch_id):
        ...
        fw=open('/content/drive/MyDrive/ewhain_original/대학원/연구/New_Davedrum/confidence_acc_test.txt','a',encoding='utf-8')
